      ...
      <div class="col-md-3">
          ...
          <v-card class="default mb-5">
            <v-card-text>
              ...
              <v-btn v-if="mode != 'view'" class="mt-5" color="info" @click="addName()">
                Add Alternate Name
              </v-btn>
            </v-card-text>
          </v-card>
      ...
      <div class="col-md-5">
        <v-card class="default mb-5">
          <v-card-text>
            ...
            <div class="row" v-for="(item, i) of fnNames" :key="i">
              <div class="col-md-11">
                <v-row>
                  <div class="col-md-6">
                    <v-text-field
            ...
            <v-btn v-if="mode != 'view'" class="mt-5" color="info" @click="addFnName()">
        ...
        <v-card class="default mb-5">
          <v-card-text>
            ...
            <v-btn v-if="mode != 'view'" class="mt-5" color="info" @click="addFNAssociation()">
              Add Association
            </v-btn>
          </v-card-text>
        </v-card>
