<template>
<<<<<<< HEAD:src/web/src/components/AirplaneCrashes/AirplaneComponents/MapLoader.vue
...
>>>>>>> 68a9650 (Finished create/edit places form and print screen. Only the photos widget is left):src/web/src/components/MapLoader.vue
</template>
