<template>
  <div>
    <v-card-title primary-title> Associations </v-card-title>
      ...
      <v-container>
        <v-row>
          <v-col cols="12">
            ...
            <v-alert
              v-for="(item, i) in fields.associations"
              :key="`theme-${i + 1}`"
              outlined
              color="primary"
            >
              <div class="sub-title">Association {{ i + 1 }}</div>
              <v-btn
                icon
                color="primary"
            ...
            <v-btn outlined color="primary" @click="addItem('associations')">
              Add New
            </v-btn>
          </v-col>
        </v-row>
        ...
        <v-row>
          <v-col cols="12">
            ...
            <v-alert
              v-for="(item, i) in fields.firstNationAssociations"
              :key="`theme-${i + 1}`"
              outlined
              color="primary"
            >
              <div class="sub-title">First Nation Association {{ i + 1 }}</div>
              <v-btn
                icon
                color="primary"
                class="top-right-button"
