      ...
      <v-container>
        <v-row>
          <v-col cols="6">
            ...
            <v-combobox v-model="fields.records" label="Records"></v-combobox>
          ...
          <v-col cols="6">
            ...
            <v-alert
              v-for="(item, i) in fields.secondaryNames"
              :key="`secondary-name-${i}`"
              outlined
              color="primary"
            >
            ...
            <v-alert
              v-for="(item, i) in fields.historicalPatterns"
              :key="`historical-pattern-${i}`"
              outlined
              color="primary"
            >
