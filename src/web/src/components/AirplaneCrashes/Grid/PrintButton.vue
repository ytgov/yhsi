...
export default {
    ...
    data: ()=> ({
        ...
        toPrint: {},
        textpos: 0,
        headers: [ "YACSI Number", "Crash Date", "Aircraft Type", "Aircraft Registration", 
            "Country",  "Registration Type",  "Location Description",
            "Pilot First Name", "Pilot Last Name", "Souls Onboard", "Fatalities"],
    }),
    methods: {
