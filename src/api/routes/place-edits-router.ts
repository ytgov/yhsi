...
placeEditsRouter.post(
	...
	[
		...
		body('bordenNumber').isString(),
		body('category').isInt(),
		body('communityId').isInt(),
		body('contributingResources').isArray(),
		body('coordinateDetermination').isInt(),
		body('designations').isArray(),
		body('hectareArea').isString(),
		body('historicalPatterns').isArray(),
		body('latitude').isString(),
		body('locationComment').isString(),
		body('locationContext').isString(),
		body('longitude').isString(),
		body('names').isArray(),
		body('nTSMapSheet').isString(),
		body('otherCommunity').isString(),
		body('otherLocality').isString(),
		body('physicalAddress').isString(),
		body('physicalCountry').isString(),
		body('physicalPostalCode').isString(),
		body('physicalProvince').isString(),
		body('previousAddress').isString(),
