...
exports.up = async function (knex: Knex, Promise: any) {
	...
	await knex.schema.createTable(
		...
		function (t: Knex.CreateTableBuilder) {
			...
			t.specificType('create_date', 'datetime2(0)')
				.notNullable()
				.defaultTo(knex.raw('GETDATE()'), {
					constraintName: 'User_create_date_default',
				});
